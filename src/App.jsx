...
function Inner(){
  ...
  return <div className={`${theme?"bg-gray-950 h-screen transition ease-in-out duration-500":"bg-blue-600 h-screen transition ease-in-out duration-500"} text-blue-200`}>
    <Head/>
    <Editors/>
